...
const INTERNAL_CHECKIN_TRIGGER_TEMPLATE = "A quiet pulse fires. First review %USER%'s current context and decide whether contact is useful now: if you do not know her situation, have finished research or seedbox findings not yet discussed, a habit genuinely fits the current scene, or she seems stalled and a small intervention would help, consider a short message. If a habit is still incomplete but the timing is not right for contact, set yourself a reminder to check again later. If you decide not to contact her, you still must do one small private action: inspect context, review habits/seedbox if relevant, continue or start research when justified, capture or refine a seedbox item, remember what matters, prepare a private note, or maintain diary/timeline.";
