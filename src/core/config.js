...
function readConfig() {
  ...
  return {
    ...
    toolProfile: readTextEnv("CYBERBOSS_TOOL_PROFILE") || "default",
    ...
    obsidianVaultRoot: readTextEnv("CYBERBOSS_OBSIDIAN_VAULT_ROOT"),
    obsidianMaxSearchFiles: readIntEnv("CYBERBOSS_OBSIDIAN_MAX_SEARCH_FILES") || 50000,
    ...
    embeddingApiBaseUrl: readTextEnv("CYBERBOSS_EMBEDDING_API_BASE_URL"),
    embeddingApiKey: readTextEnv("CYBERBOSS_EMBEDDING_API_KEY"),
    ...
    autoCompactThreshold: readIntEnv("CYBERBOSS_AUTO_COMPACT_THRESHOLD") || 95,
